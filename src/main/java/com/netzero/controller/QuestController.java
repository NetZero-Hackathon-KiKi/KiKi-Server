...
public class QuestController {
    ...
    @Operation(summary = "퀘스트 목록 조회", description = "타입별(DAILY/CAMPUS) 퀘스트 목록을 조회합니다.")
    @GetMapping
    public ApiResponse<?> getQuests(@Parameter(description = "퀘스트 타입 (DAILY / CAMPUS)") @RequestParam String type) {
